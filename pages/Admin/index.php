...
<meta charset="utf-8">
<link href="..\Admin\layout\styles\layout.css" rel="stylesheet" type="text/css" media="all">
</head>
<body id="top">
<!-- ################################################################################################ -->
...
<!-- ################################################################################################ -->
<div class="wrapper row1 bgded" style="background-image:url('../Admin/BookOnline/images/demo/backgrounds/8.jpg')">
...
<div class="wrapper row3">
  <main id="container" class="clear"> 
    ...
    <div class="clear center btmspace-80">
      ...
      <div class="one_third">
        <div class="boxedicon"><a class="circle" href="..\Admin\services.php"><i class="fa fa-gift fa-2x"></i></a></div>
      ...
      <div class="one_third">
        <div class="boxedicon"><a class="circle" href="..\Admin\BookOnline\Bookonline.php"><i class="fa fa-history fa-2x"></i></a></div>
