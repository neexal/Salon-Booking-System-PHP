...
<!-- ################################################################################################ -->
  <div class="wrapper row0">
    <nav id="mainav"> 
      ...
      <li><a href="/SalonBookingTesting/pages/Admin/adminlogin/userlogout.php" style="position: relative; bottom: 76px; left: 41em;">Log out</a></li>
      </ul>
      <!-- ################################################################################################ --> 
    </nav>
  ...
  <div class="wrapper row1 bgded" style="background-image:url('images/demo/backgrounds/9.jpg')">
    <header id="header" class="clear"> 
      <div class="alert alert-success" role="alert">
           <p class="header-para">Appointment has been scheduled successfully.</p>
      </div>
      <!-- ################################################################################################ -->
      <!-- ################################################################################################ --> 
    </header>
