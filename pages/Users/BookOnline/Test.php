  ...
  <div class="wrapper row0">
    <nav id="mainav"> 
      ...
      <ul id="nav" class="clear">
        ...
        <li class="active"><a href="..\BookOnline\index.html">Book Online</a></li>
        <li><a href="..\userlogin\userlogin.html">Sign In</a></li>
  ...
  <div class="wrapper row1 bgded" style="background-image:url('images/demo/backgrounds/9.jpg')">
    <header id="header" class="clear"> 
      <div class="alert alert-success" role="alert">
           <p class="header-para">Your Appointment has been scheduled successfully. Please contact us to cancel an appointment.</p>
      </div>
      <!-- ################################################################################################ -->
      <!-- ################################################################################################ --> 
    </header>
        ...
        <div class="container">
          ...
          <div class="form-field">
            ...
            <!-- Email input -->
              ...
              <!-- Password input -->
              <div class="form-outline mb-4">
                <input type="text" id="form2Example2" class="form-control" name="gender" />
            ...
            <!-- Email input -->
              <div class="form-outline mb-4">
                <input type="text" id="form2Example1" class="form-control" name="contact" />
          ...
          <select class="form-contro" name="services" id="service">
                  ...
                  <!-- Home Ware -->
                  <option name="staffs"  data-price="<?php echo $result[2];?>" time="<?php echo $result[3];?>" value="<?php echo $result[0];?>"><?php echo $result[1];?></option>
                <?php endwhile;?>
               </select>
              ...
              <div class="form-outline mb-4">
                <select class="subcat" id="category2" name="staffs">
            
                  <option value>Available Staffs</option>
                         <?php while ($result= mysqli_fetch_array($data)):;?>
                  <!-- Home Ware -->
                  <option name="staffs" value="<?php echo $result[0];?>"><?php echo $result[1];?></option>
                <?php endwhile;?>
                </select>
              </div> 
      </div>
            ...
            <div class="form-outline mb-4">
                ...
                <label class="form-labe" id="times" name="timet" for="form2Example2">Time Taken</label>
              </div>
            </div>
